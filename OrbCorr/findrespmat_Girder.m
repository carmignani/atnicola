function C = findrespmat_Girder(RING, indbpm, PLANE, PVALUE, ORBITFUNCTION)
...
%     end
    if PLANE == 'H'
        RING2=atsetshift_Girder(RING,i,+PVALUE(i),0,0,0);
    elseif PLANE == 'V'
        RING2=atsetshift_Girder(RING,i,0,+PVALUE(i),0,0);
    end
    ORBITPLUS  = feval(orbit_function_handle,RING2,orbit_function_args{:});
    if PLANE == 'H'
        RING2=atsetshift_Girder(RING,i,-1*PVALUE(i),0,0,0);
    elseif PLANE == 'V'
        RING2=atsetshift_Girder(RING,i,0,-1*PVALUE(i),0,0);
    end
